...
document.addEventListener("DOMContentLoaded", function () {
    const GITHUB_REPO_URL = "https://github.com/s03807f-Yeims/s03807f.github.io"; // enlace al repositorio (ajusta si lo deseas)
    ...
    let semanas = [
      { id: "semana1", label: "Semana 1", descripcion: "Manuales e informe técnico.", archivos: [
      ...
      { id: "semana2", label: "Semana 2", descripcion: "Actividades de la semana N° 2.", archivos: [
      ...
      { id: "semana3", label: "Semana 3", descripcion: "Actividades de la semana N°3", archivos: [
      ...
      { id: "semana4", label: "Semana 4", descripcion: "Documentos de la semana 4.", archivos: [
      ...
      { id: "semana5", label: "Semana 5", descripcion: "Creacion de base de datos QhantuPeru.", archivos: [
        { nombre: "Base de datos de QhatuPeru", enlace: "archivos/semana5_Qhatu1.pdf" }
      ]},
      { id: "semana6", label: "Semana 6", descripcion: "Semana 6 y sus actividades.", archivos: [
        { nombre: "Actividades de la semana 6", enlace: "archivos/semana6_actividades.pdf" }
      ]},
      { id: "semana7", label: "Semana 7", descripcion: "Introducción a algoritmos de búsqueda y ordenamiento.", archivos: [
        { nombre: "Busqueda.pdf", enlace: "archivos/semana7_busqueda.pdf" },
        { nombre: "Ejercicios.pdf", enlace: "archivos/semana7_ejercicios.pdf" }
      ]},
      { id: "semana8", label: "Semana 8", descripcion: "Programación orientada a objetos: conceptos básicos.", archivos: [
        { nombre: "POO.pdf", enlace: "archivos/semana8_poo.pdf" },
        { nombre: "Ejercicios.pdf", enlace: "archivos/semana8_ejercicios.pdf" }
      ]},
      { id: "semana9", label: "Semana 9", descripcion: "Herencia y polimorfismo en POO.", archivos: [
        { nombre: "Herencia.pdf", enlace: "archivos/semana9_herencia.pdf" },
        { nombre: "Ejercicios.pdf", enlace: "archivos/semana9_ejercicios.pdf" }
      ]},
      { id: "semana10", label: "Semana 10", descripcion: "Excepciones y manejo de errores.", archivos: [
